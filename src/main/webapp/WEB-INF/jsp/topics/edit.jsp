                            ...
                            <div class="panel-body row-fluid">
                                <div class="col-md-12 text-center">
                                    <div class="thumbnail text-center" style="border: 0 none; width: 100%;">
                                        <img class="img-responsive img-rounded" id="imgPlacehold" src="${topic.preImage}"/>
                                        <div class="caption">
                                            <div class="input-group text-center">
                                                <input id="preImage" name="preImage" type="text" class="form-control" value="${topic.preImage}"/>
                            ...
                            <div class="panel-body row-fluid">
                                <div class="col-md-12">
                                    <div id="topic-preAudio">
                                        <audio id="audioPlacehold" controls style="width: 100%;" src="${topic.preAudio}"/>
                                    </div>
                                    <div class="input-group" style="width: 100%;">
                                        <input id="preAudio" name="preAudio" type="text" class="form-control" value="${topic.preAudio}"/>
                                        <span class="input-group-btn">
