					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="${x}/back/content/pages/create" >创建</a></li>
							</ul>
							<div class="tab-content">
								<form role="form" action="${x}/back/content/pages/save" method="POST"
									data-toggle="validator">
									<div class="form-group">
										<label>标题</label> <input name="title" class="form-control" >
										<div class="help-block with-errors"></div>
									</div>
									<div class="form-group">
										<label>链接</label> <input name="url"  class="form-control">
										<div class="help-block with-errors"></div>
									</div>
									<div class="form-group">
										<label>正文</label>
