					...
					<ul class="list-group-panel-body list-group list-group-users">
						...
						<li class="list-group-item">
							<div class="media">
								...
								<a href="${x}/users/${follow.userByFollowingId.id}/following">
								<h4 class="media-heading">${follow.userByFollowingId.nick}</h4></a>
									<p>	
										${follow.userByFollowingId.signature}
									</p>
								</div>
