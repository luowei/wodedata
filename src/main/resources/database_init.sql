...
-- ----------------------------
BEGIN;
INSERT INTO `node` VALUES ('8', null, '就是用来测试的', '6', 'test', '0', '2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `section` VALUES ('2', 'test', '0');
COMMIT;
...
-- ----------------------------
--  Records of `user`
--  default user: luowei/luowei , admin/name350
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('7', 'http://tp2.sinaimg.cn/3888714809/180/5727878850/1', null, null, '2016-03-20 16:46:19', null, 'luowei@wodedata.com', null, null, null, 'luowei', '0', 'ab8bbd7e77282a0367ffbb1cd2603132', '0', 'admin', null, null, null, null, 'luowei'), ('8', 'http://tp2.sinaimg.cn/3888714809/180/5727878850/1', null, null, '2016-03-20 18:02:39', null, 'admin@wodedata.com', null, null, null, 'admin', '1', '6eb67c74e9cb2b80630e4ac10c4b4635', '0', 'admin', null, null, null, null, 'admin');
COMMIT;
